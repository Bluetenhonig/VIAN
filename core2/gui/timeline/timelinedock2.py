...
class TimelineDock(VIANDockWidget):
    def __init__(self, main_window):
        ...
        self.menu_tools = self._mw.menuBar().addMenu("Tools")
        ...
        self.menu_display = self._mw.menuBar().addMenu("Display")
        ...
        self.menu_options = self._mw.menuBar().addMenu("Options")
        ...
        self._mw.addToolBar(Qt.LeftToolBarArea, self.toolbar)


        # self.inner.addToolBar(self.toolbar)

    def resizeEvent(self, *args, **kwargs):
        super(TimelineDock, self).resizeEvent(*args, **kwargs)
...
class Timeline(QtWidgets.QWidget, IProjectChangeNotify, ITimeStepDepending):
    ...
    def __init__(self, main_window, parent):
        ...
        self.time_scrubber = TimelineScrubber(self.frame_Bars, main_window, self)
...
class TimelineScrubber(QtWidgets.QWidget):
    def __init__(self, parent, main_window, timeline):
    ...
    def mousePressEvent(self, QMouseEvent):
        if QMouseEvent.buttons() & Qt.LeftButton:
            ...
            self.was_playing = self.main_window.player.is_playing()
